...
function handlePlanetChange() {
  ...
  //console.log("Planet Size: " + planetSizeRoll.value)
  ...
  //console.log("Atmosphere: " + planetAtmosphereRoll.value)
  ...
  if (selectedPlanetValue.value === 4) {
    ...
    //console.log("Temperature: " + planetTemperatureRoll.value)
  ...
  //console.log("Geosphere Roll: " + planetGeosphereRoll.value)
  ...
  if (selectedPlanetValue.value === 3) {
    ...
    //console.log("Planet Terrain Roll: " + planetTerrainRoll.value)
    ...
    //console.log("Ice Terrain Roll: " + planetIceTerrainRoll.value)
  ...
  //console.log("PG Trigger: " + planetGeneratorTrigger.value)
