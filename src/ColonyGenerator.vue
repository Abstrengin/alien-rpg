...
function handleColonyGen() {
  ...
  //console.log( sharedState.pgPlanetSizeRoll )
  ...
  //console.log(colonyMissionMod)
  //console.log(colonyMissionRoll.value)
  ...
  //console.log(numberOfFactionsRoll.value)
  ...
  //console.log(colonyFactionsRoll.value)
  ...
  //console.log("Colony Alliance: " + colonyAllegianceRoll.value)
  ...
  //console.log("Scenario Hooks: " + scenarioHooksRoll.value)
  ...
  //console.log("Colony Generator Trigger: " + colonyGeneratorTrigger.value)
}
