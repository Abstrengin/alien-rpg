        ...
        <div class="sticky top-24 space-y-4">
          ...
          >
            ...
            <Modal v-model:model-value="showAppInfo" title="ABOUT THIS TOOL">
              <p class="mb-3">
                <strong>Space Travel Tool</strong> calculates FTL travel time, crew pay periods, and
                hypersleep event rolls from a ship's FTL rating and the distance in parsecs.
              </p>
              <p class="mb-3">
