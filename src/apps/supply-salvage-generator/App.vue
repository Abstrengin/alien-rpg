        ...
        <div class="sticky top-24 space-y-4">
          ...
          >
            ...
            <Modal v-model:model-value="showAppInfo" title="ABOUT THIS TOOL">
              <p class="mb-3">
                <strong>Supply & Salvage Generator</strong> rolls up what a crew finds when they
                search a derelict, station or wreck. Every item comes from the rulebook gear tables
                with its printed weight, cost, effect and supply ratings.
              </p>
              <p class="mb-3">
                Each haul is totalled into a <strong>salvage value</strong> and an
                <strong>encumbrance</strong> figure, so you know what it is worth and who is strong
                enough to carry it. The built-in <strong>supply roll</strong> panel handles air,
                ammo and power on the spot.
              </p>
              <p class="mb-3">
