        ...
        <div class="sticky top-24 space-y-4">
          ...
          >
            ...
            <Modal v-model:model-value="showAppInfo" title="ABOUT THIS TOOL">
              <p class="mb-3">
                <strong>Contract & Cargo Generator</strong> rolls a complete space trucker job:
                employer, cargo manifest, destination, distance, difficulty, base payment,
                complications, bonus rewards and a plot twist.
              </p>
              <p class="mb-3">
                The canonical layer follows the <strong>Job Generator</strong> and
                <strong>Cargo Runs</strong> tables from the rulebooks, so results drop straight into
                play. An optional <strong>table dressing</strong> layer adds employer voice,
                handling notes, deadline pressure and contract fine print.
              </p>
              <p class="mb-3">
