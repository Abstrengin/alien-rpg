        ...
        <div class="sticky top-24 space-y-4">
          ...
          >
            ...
            <Modal v-model:model-value="showAppInfo" title="ABOUT THIS TOOL">
              <p class="mb-3">
                <strong>Ship Generator</strong> builds a ship off the book's own Ship Classes table:
                FTL Rating, Signature, Thrusters, Hull and armor, then fits a legal loadout of
                internal modules, upgrades and armaments into the slots and hardpoints the class
                actually has, and totals what the whole thing costs.
              </p>
              <p class="mb-3">
                Or pull one of the named ships of the setting straight from the page, from the
                Starcub shuttle to the Conestoga-Class frigate. Either way the condition panel rolls
                real faults on the <strong>Minor Component Damage</strong> D66 and
                <strong>Major Component Damage</strong> 2D6 tables, with the repair rolls each one
                needs.
              </p>
              <p class="mb-3">
